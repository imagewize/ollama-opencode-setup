...
| `mistral-small3.2-24b-16k.Modelfile` | `mistral-small3.2:latest` | 16k | ✅ 100% GPU, 16 GB (M4 24GB); lighter KV cache than 32k | `ollama create mistral-small3.2:24b-16k -f modelfiles/mistral-small3.2-24b-16k.Modelfile` |
